...
def seed_merchants():
    ...
    with app.app_context():
        ...
        merchants = [
            ...
            {
                "merchant_id": "demo_merchant_cafeteria",
                "shop_name": "College Cafeteria",
                "owner_name": "Chef Dev",
                "email": "cafeteria@merchant.college.edu",
            ...
            {
                "merchant_id": "demo_merchant_stationery",
                "shop_name": "Campus Stationery",
                "owner_name": "Aarav Store",
                "email": "stationery@merchant.college.edu",
                "password": "password123",
                "category": "print_store",
                "location": "Library Block",
                "status": "active",
            ...
            {
                "merchant_id": "demo_merchant_labstore",
                "shop_name": "Lab Equipment Store",
                "owner_name": "Dr. Sen",
                "email": "labstore@merchant.college.edu",
                "password": "password123",
                "category": "lab_store",
