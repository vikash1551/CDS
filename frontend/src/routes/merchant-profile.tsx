    ...
    <MerchantShell>
      <TopBar title="Store Profile" back={false} right={
        <button
          ...
          className="flex items-center gap-1 rounded-full bg-brand px-3 py-1.5 text-[11px] font-bold text-brand-foreground active:scale-95"
        >
      ...
      <div className="px-4 pt-2 pb-6">
        {/* Store Header */}
        <div className="relative rounded-2xl overflow-hidden mb-5" style={{ background: "linear-gradient(135deg, var(--brand), var(--secondary))" }}>
          <div className="p-5 text-white">
            <div className="flex items-start gap-4">
              <div className="relative">
                ...
                {editing && (
                  <label className="absolute -bottom-1 -right-1 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-white text-brand shadow active:scale-95 transition-transform">
              ...
              <div className="flex-1">
                ...
                <p className="text-[11px] opacity-70 mt-0.5 flex items-center gap-1"><MapPin className="h-3 w-3" /> Campus, Block A</p>
        ...
        <div className="rounded-2xl border border-border bg-card p-4 mb-4">
          ...
          {editing ? (
            <textarea value={storeDesc} onChange={(e) => setStoreDesc(e.target.value)} rows={3} className="w-full rounded-xl border border-input bg-background p-3 text-sm outline-none focus:border-brand resize-none" />
          ) : (
        ...
        <div className="rounded-2xl border border-border bg-card p-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <div key={a.name} className="rounded-xl border border-brand/20 bg-brand/5 p-3 text-center">
